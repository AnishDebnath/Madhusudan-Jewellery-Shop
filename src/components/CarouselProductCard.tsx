...
const CarouselProductCard: React.FC<CarouselProductCardProps> = ({
  ...
  const getTag = () => {
    if (showNewArrival) return 'New Launch';
    if (showBestseller) return 'Best Seller';
  ...
  return (
    <div className="flex-shrink-0 w-full group relative bg-white dark:bg-luxury-dark-card border border-transparent dark:border-white/5 hover:border-gold/20 overflow-hidden hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 cursor-pointer rounded-[2rem] h-full flex flex-col p-3 md:p-4">
      {/* Image Container - Matching Signature Collections */}
      <div
      ...
      {/* Info Container - Center Aligned matching Signature Collections */}
