...
const MobileAccordionItem: React.FC<{
  ...
  return (
    <div className="border-b border-white/5">
      ...
      {isOpen && (
        <div className="px-5 pb-5 grid grid-cols-1 gap-1 animate-in fade-in slide-in-from-top-2 duration-200 bg-white/[0.02] border-t border-white/5">
    ...
    <>
      ...
      {isMenuOpen && (
        ...
        >
          ...
          >
            {/* Sidebar Header */}
            <div className="border-b border-white/10 px-6 py-5 flex justify-between items-center shrink-0">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      {[
                        ...
                        <button
                          key={label}
                          onClick={() => { setIsMenuOpen(false); onNavigate(view as PageView); }}
