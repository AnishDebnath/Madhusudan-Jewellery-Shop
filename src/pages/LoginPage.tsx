        ...
        <div className="bg-luxury-bg-primary dark:bg-luxury-dark-primary flex flex-col md:flex-row w-full border-t border-luxury-bg-card dark:border-white/5 transition-colors relative">
            ...
            <div className="w-full md:w-1/2 relative min-h-[400px] md:min-h-0 md:fixed md:left-0 md:top-[110px] lg:top-[140px] md:bottom-0 overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-maroon-dominant/90 via-maroon-dominant/40 to-transparent flex flex-col justify-end p-12 lg:p-20">
                    ...
                    <h3 className="text-white font-serif text-4xl lg:text-5xl leading-tight mb-4">Crafting Timeless <br />Elegance</h3>
                    <p className="text-white/70 text-sm font-light italic max-w-md">Experience the pinnacle of fine jewelry making, where every piece tells a story of heritage.</p>
                </div>
            </div>
            ...
            <div className="w-full md:w-1/2 md:ml-[50%] flex flex-col justify-center min-h-[calc(100vh-110px)] lg:min-h-[calc(100vh-140px)] p-10 md:p-14 lg:p-24 bg-luxury-bg-primary dark:bg-luxury-dark-card relative z-10">
                <div className="max-w-md mx-auto w-full">
                    ...
                    <div className="flex flex-col items-center mb-10">
                        ...
                        <h2 className="text-3xl font-serif text-maroon-dominant dark:text-white uppercase tracking-wider text-center">Welcome Back</h2>
                        <p className="text-luxury-text-light/60 dark:text-luxury-text-darkMuted italic text-center mt-3 text-sm">Sign in to continue exploring our timeless heritage.</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-3 group">
                            <div className="flex justify-between items-center px-1">
                                <label className="text-[9px] uppercase tracking-widest text-luxury-text-light/50 dark:text-luxury-text-darkMuted font-black group-focus-within:text-gold transition-colors">Password</label>
                                <button type="button" className="text-[9px] uppercase tracking-widest text-gold hover:text-maroon-dominant dark:hover:text-white transition-colors font-black">Forgot?</button>
                            </div>
                            <div className="relative">
                                <input
                                    type="password"
                        ...
                        >
                            <span className="relative z-10 group-hover:tracking-[0.3em] transition-all duration-300">Sign In</span>
                    ...
                    <div className="mt-10 pt-8 border-t border-luxury-bg-card dark:border-white/10 flex flex-col items-center">
                        <p className="text-[11px] text-luxury-text-light/60 dark:text-luxury-text-darkMuted mb-2">Don't have an account?</p>
                        <button
