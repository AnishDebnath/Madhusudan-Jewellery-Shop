...
const NewArrivals: React.FC<NewArrivalsProps> = ({ onProductClick, onToggleWishlist, wishlist, onNavigate, onAddToCart }) => {
  ...
  return (
    <section className="py-12 md:py-16 bg-luxury-bg-primary dark:bg-luxury-dark-primary transition-colors overflow-hidden border-b border-gold/10 relative">
      ...
      <div className="max-w-[1440px] mx-auto px-4 md:px-8 lg:px-10 xl:px-12 relative z-10">
        <div>
          <div className="flex items-center justify-between mb-8 pb-4 border-b border-maroon-dominant/5 dark:border-white/5 flex-col md:flex-row gap-6 md:gap-0 text-center md:text-left">
            ...
            {/* Desktop nav buttons (linked to shared carousel ref) - visible from 1024px up */}
      ...
      {/* "Just Dropped" Product Section — Calling the shared component with hideHeader */}
      <div className="-mt-8">
        <ProductCarouselSection
          ...
          hideHeader={true}
          sectionClassName="relative py-14 overflow-hidden bg-transparent transition-colors z-20"
        />
      </div>
