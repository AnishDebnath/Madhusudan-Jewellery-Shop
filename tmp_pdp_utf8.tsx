          ...
          <div className="lg:w-1/2">
            <div className="mb-10 pb-10 border-b border-luxury-bg-card dark:border-white/10">
              ...
              <div className="flex flex-wrap items-center gap-6 mb-8">
                ...
                <span className="text-[10px] text-luxury-text-light/40 dark:text-luxury-text-darkMuted uppercase tracking-widest font-bold">ΓÇó &nbsp; 12 Verified Reviews</span>
              </div>

              <div className="space-y-2">
                <p className="text-4xl font-sans font-bold tracking-tight text-maroon-dominant dark:text-gold">Γé╣{product.price.toLocaleString('en-IN')}</p>
                    ...
                    return (
                      <div className="space-y-0.5">
                        <div className="flex justify-between items-end py-3 border-b border-luxury-bg-card/50 dark:border-white/5 group hover:bg-gold/5 transition-colors -mx-4 px-4 rounded-lg">
                          ...
                          <span className="text-lg font-serif text-maroon-dominant dark:text-white">Γé╣{goldValue.toLocaleString('en-IN')}.00</span>
                        </div>
                        <div className="flex justify-between items-end py-3 border-b border-luxury-bg-card/50 dark:border-white/5 group hover:bg-gold/5 transition-colors -mx-4 px-4 rounded-lg">
                          ...
                          <span className="text-lg font-serif text-maroon-dominant dark:text-white">Γé╣{makingCharge.toLocaleString('en-IN')}.00</span>
                        </div>
                        <div className="flex justify-between items-center py-4 border-b border-gold/20 -mx-4 px-4 rounded-lg my-1">
                          ...
                          <span className="text-xl font-serif text-gold font-bold">Γé╣{grandTotal.toLocaleString('en-IN')}.00</span>
                        </div>
                        <div className="flex justify-between items-end py-3 border-b border-luxury-bg-card/50 dark:border-white/5 group hover:bg-gold/5 transition-colors -mx-4 px-4 rounded-lg">
                          ...
                          <span className="text-lg font-serif text-maroon-dominant dark:text-white">Γé╣{gst3.toLocaleString('en-IN')}.00</span>
                        </div>
                        <div className="flex justify-between items-end py-3 border-b border-luxury-bg-card/50 dark:border-white/5 group hover:bg-gold/5 transition-colors -mx-4 px-4 rounded-lg">
                          ...
                          <span className="text-lg font-serif text-maroon-dominant dark:text-white">Γé╣{netAmount.toLocaleString('en-IN')}.00</span>
                        </div>
                        <div className="flex justify-between items-end py-3 border-b border-luxury-bg-card/50 dark:border-white/5 group hover:bg-gold/5 transition-colors -mx-4 px-4 rounded-lg">
                          ...
                          <span className="text-lg font-serif text-maroon-dominant dark:text-white">Γé╣{roundOff}</span>
                        </div>
                        <div className="mt-6 pt-6">
                          <div className="bg-gold/10 -mx-4 px-6 py-5 rounded-xl border border-gold/20 flex items-center justify-between group">
                            ...
                            <span className="text-3xl font-sans text-maroon-dominant dark:text-gold font-bold tracking-tight drop-shadow-sm group-hover:scale-105 transition-transform duration-300">
                              Γé╣{payableAmount.toLocaleString('en-IN')}
                            </span>
                          </div>
                        </div>
                      </div>
